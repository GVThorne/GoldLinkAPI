...
.. note::
    ...
    A Javascript example that interacts with the Gold-Link API can be found here: `Javascript Example <https://github.com/GVThorne/GoldLinkAPI/tree/master/Javascript%20Example>`_
...
.. note::
    ...
    A PHP example that interacts with the Gold-Link API can be found here: `PHP Example <https://github.com/GVThorne/GoldLinkAPI/tree/master/PHP%20Example>`_
